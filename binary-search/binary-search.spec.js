...
describe('Binary Search', () => {
	...
	it('returns true if target value is in a smaller array', () =>{
	expect(binarySearch(test4, 2)).to.equal(true);
	});

	it('returns false if target value is not in a smaller array', () =>{
		expect(binarySearch(test4, 7)).to.equal(false);
	});
